...
bool QPGPatternSpecification::operator <(const QPGPatternSpecification& Spec) {
    ...
    case SpecificationSortType::DifficultyMarksChapter:
        return (difficultyLevel < Spec.difficultyLevel || (difficultyLevel == Spec.difficultyLevel && marks < Spec.marks )
    ...
    case SpecificationSortType::MarksChapterDifficulty:
        return ((marks < Spec.marks) || (marks == Spec.marks && _stricmp(chapterName.c_str(), Spec.chapterName.c_str()) < 0)
    ...
    case SpecificationSortType::MarksDifficultyChapter:
        return ((marks < Spec.marks) || (marks == Spec.marks && difficultyLevel < Spec.difficultyLevel)
