...
int QuestionBankManager::sortQuestions() {
    ...
    while (nSelectedOption != 0 && nSelectedOption != 9) {
        cout << string(100, '\n');
        cout << "\n        **********   SORT OPTIONS  **********";
        cout << "\n           1   Chapter, Question, Marks and Difficulty Level";
        cout << "\n           2   Question, Chapter, Marks and Difficulty Level";
        cout << "\n           3   Marks, Chapter, Difficulty Level and Question";
        cout << "\n           4   Chapter, Marks, Difficulty Level and Question";
        cout << "\n           5   DifficultyLevel Marks, Chapter and Question";
        cout << "\n           9   Return To Previous Menu";
        cout << "\n           0   Exit" << endl;
        cout << "\n Select the option:";
        cin >> nSelectedOption;
