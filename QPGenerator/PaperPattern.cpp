...
void PaperPattern::setSpecification(){
    ...
    while (nSelectedOption < 0) {
        ...
        if (totalMarksSet != 20) {
            cout << "Still total marks not set to 20 " << endl;
        }
        ...
        cin >> nSelectedOption;
        if (nSelectedOption > 0 && totalMarksSet < 20) {
            if (moveToSpecification(nSelectedOption) == NULL) {
                ...
                while (NoOfQuestion < 0) {
                    ...
                    cin >> NoOfQuestion;
                    if (NoOfQuestion > qPattern.getCurrent()->getquestionsInQBank() && totalMarksSet < 20) {
...
int PaperPattern::sortSpecifications() {
    ...
    while (nSelectedOption != 0 && nSelectedOption != 9) {
        cout << string(100, '\n');
        cout << "\n        **********   SORT OPTIONS  **********";
        cout << "\n           1   Marks, Chapter and Difficulty Level";
        cout << "\n           2   Marks, Difficulty Level and Chapter";
        cout << "\n           3   Chapter, Marks and Difficulty Level";
        cout << "\n           4   Chapter, Difficulty Level and Marks";
        cout << "\n           5   Difficulty Level, Chapter and Marks";
        cout << "\n           6   Difficulty Level, Marks and Chapter";
        cout << "\n           9   Return To Previous Menu";
        cout << "\n           0   Exit" << endl;
        cout << "\n Select the option:";
        cin >> nSelectedOption;
